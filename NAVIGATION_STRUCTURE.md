...
│   ├── Step 3 - Foundations Design (nav_order: 3)
│   ├── Step 4 - Present (nav_order: 4)
│   └── References (nav_order: 5)
├── 🤖 AI Agent Challenge (nav_order: 4, has_children: true)
│   ├── Overview (nav_order: 0)
│   ├── Step 1 - Agentic AI Principles & Patterns (nav_order: 1)
│   ├── Step 2 - Functional Requirements (nav_order: 2)
│   ├── Step 3 - Non-Functional Requirements (nav_order: 3)
│   ├── Step 4 - Solution Design (nav_order: 4)
│   ├── Step 5 - Integration (nav_order: 5)
│   ├── Step 6 - Present (nav_order: 6)
│   └── References (nav_order: 7)
