...
Welcome to the **IFS End-to-End Azure AI Solution Workshop**. This two-day workshop guides you through the complete process of designing a secure, scalable, and well-governed AI solution for Innovate Financial Services (IFS). The agenda is structured to mirror a real-world AI adoption journey, from foundational design to enterprise-scale AI governance.

---

## Workshop Objectives

- Understand IFS’s business drivers and AI adoption vision
- Design secure, scalable Azure foundations using Landing Zone principles
- Architect a Retrieval-Augmented Generation (RAG) chatbot workload
- Develop a centralized AI Hub for enterprise-wide AI governance
- Present and justify architectural decisions using Azure best practices
...
| 10:15 - 10:30 | **Break** |  |
| 10:30 - 12:00 | **AI Ready Challenge - Part 1** | * Understand the Customer<br>* Define Requirements |
| 12:00 - 13:00 | **Lunch** |  |
| 13:00 - 15:00 | **AI Ready Challenge - Part 2** | * Design the Foundations<br>* Design Application Landing Zones |
| 15:00 - 15:15 | **Break** |  |
| 15:15 - 16:30 | **AI Ready Challenge - Presentations** | * Group presentations of Landing Zone architecture designs<br>* Feedback and discussion |
